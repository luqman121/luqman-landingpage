  ...
  return (
    <section className="py-10 md:py-16 px-4">
      <div className="max-w-5xl mx-auto">
        <ScrollReveal>
          <div className="bg-white rounded-[1.5rem] md:rounded-[2rem] shadow-xl border border-slate-100 px-5 py-10 md:px-12 md:py-16 text-center">
            {/* Icon */}
            ...
            {/* Title */}
            <h2 className="font-heading text-2xl md:text-4xl font-bold text-slate-900 mb-4 leading-tight">
              ابدأ بموظف AI اليوم
            </h2>

            {/* Subtitle */}
            <p className="text-slate-500 max-w-xl mx-auto mb-8 leading-relaxed text-sm md:text-base">
