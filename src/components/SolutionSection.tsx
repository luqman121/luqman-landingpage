          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollReveal>
              <div className="text-center lg:text-right">
                ...
                {/* Section badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-50 dark:bg-brand-900/20 border border-brand-200 text-brand-700 text-sm font-semibold mb-4">
                  <Rocket size={14} />
                  <span>الحل الذكي</span>
                </div>

                <h2 className="font-heading text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4 leading-tight">
            ...
            <ScrollReveal delay={0.2}>
              <div className="space-y-3">
                {solutionPoints.map((point, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-r from-slate-50 to-white border border-slate-100 dark:border-slate-700 hover:border-brand-200 hover:bg-gradient-to-r hover:from-brand-50 hover:to-white transition-all duration-300 group cursor-default shine-card"
